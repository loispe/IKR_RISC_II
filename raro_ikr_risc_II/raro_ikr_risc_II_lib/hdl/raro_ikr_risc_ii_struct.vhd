...
ARCHITECTURE struct OF raro_ikr_risc_II IS
   ...
   SIGNAL rME_in            : word;
   SIGNAL rME_out           : word;
   SIGNAL rMEmMode_in_ex    : std_logic_vector(15 DOWNTO 0);
   SIGNAL rMemMode_in_dc    : std_logic_vector(15 DOWNTO 0);
   SIGNAL rMemMode_out_ex   : std_logic_vector(15 DOWNTO 0);
   SIGNAL rMemMode_out_me   : std_logic_vector(15 DOWNTO 0);
   ...
   PORT (
      ...
      rB_in             : IN     word ;
      rC_in             : IN     word ;
      rMemMode_in_dc    : IN     std_logic_vector (15 DOWNTO 0);
      ...
      rB_out            : OUT    word ;
      rC_out            : OUT    word ;
      rMemMode_out_ex   : OUT    std_logic_vector (15 DOWNTO 0);
   ...
   PORT (
      ...
      rB_out          : IN     word ;
      rC_out          : IN     word ;
      rMemMode_out_ex : IN     std_logic_vector (15 DOWNTO 0);
      rNextPC_out_ex  : IN     word ;
      rALU_in         : OUT    word ;
      rMEmMode_in_ex  : OUT    std_logic_vector (15 DOWNTO 0);
