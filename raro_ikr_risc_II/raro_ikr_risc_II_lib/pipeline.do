...
add wave -noupdate /raro_ikr_risc_ii_tb/U_0/sbta_valid
add wave -noupdate /raro_ikr_risc_ii_tb/U_0/rSbpu_PC_in
TreeUpdate [SetDefaultTree]
quietly WaveActivateNextPane
...
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {140434 ps} 0}
